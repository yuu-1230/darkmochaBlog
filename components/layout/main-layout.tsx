  ...
  return (
    ...
    <div className="flex h-[100dvh] w-screen flex-col bg-[#1e1e1e] text-[#cccccc] overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden relative md:flex-row">
        {/* Activity Bar (補足的なサイドバーとして aside を使用) */}
        <aside
          aria-label="Activity Bar"
          className="hidden md:flex flex-col shrink-0 z-20 h-full"
        >
          <ActivityBar
        ...
        {/* Sidebar (ナビゲーションメニューとして nav を使用) */}
        <nav
          aria-label="Explorer"
          className={cn(
